// EMBASSY CATERING — src/app/events/corporate/page.tsx
...
export const metadata: Metadata = {
  title: 'Corporate Event Catering Delhi | Embassy Since 1948',
  description:
    'Premium corporate event catering in Delhi NCR — diplomatic receptions, conferences, product launches, and galas for 50–5,000 guests. Trusted by Fortune 500 and government since 1948. Quote in 24 hours.',
  openGraph: {
    title: 'Corporate Event Catering Delhi NCR | The Embassy Catering Since 1948',
    description: 'Trusted by embassies, government, and Fortune 500 for corporate catering in Delhi NCR since 1948.',
  },
  alternates: {
    canonical: 'https://embassy-catering.netlify.app/events/corporate',
  },
};
...
const corporateSchema = {
  ...
  '@graph': [
    {
      '@type': 'Service',
      '@id': 'https://embassy-catering.netlify.app/events/corporate#service',
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 3, name: 'Corporate Events', item: 'https://embassy-catering.netlify.app/events/corporate' },
      ],
    },
  ],
};
  ...
  return (
    <>
      ...
      <main style={{ paddingTop: '82px' }}>
        ...
        {/* ── HERO ── */}
        <section className="corporate-hero-section responsive-section" style={{
          ...
          <div id="corporate-hero-content" style={{ maxWidth: '900px', position: 'relative', zIndex: 2 }}>
            <ScriptEyebrow text="Corporate Event Catering" color="rgba(201,168,76,0.85)" />
            <h1 style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(44px, 6.5vw, 88px)', fontWeight: 600, color: '#FFFFFF', lineHeight: 1.05, margin: 'var(--space-lg) 0 var(--space-xl)' }}>
              Corporate Events.<br />Catering Perfected.
            </h1>
            <p className="speakable" style={{ fontFamily: 'var(--font-body)', fontSize: '16px', color: 'rgba(255,255,255,0.65)', lineHeight: 1.8, maxWidth: '540px', marginBottom: 'var(--space-3xl)' }}>
              From diplomatic receptions to high-stakes corporate galas. Trusted by embassies, government departments, and India&apos;s leading institutions since 1948.
            </p>
          ...
          <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
            <div style={{ textAlign: 'center', marginBottom: 'var(--space-4xl)' }}>
              ...
              <h2 style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(28px, 3.5vw, 48px)', fontWeight: 600, color: 'var(--color-text-dark)' }}>
                Every corporate occasion. One standard.
              </h2>
            </div>
            <div className="event-grid">
              {CORPORATE_EVENT_TYPES.map((e) => (
